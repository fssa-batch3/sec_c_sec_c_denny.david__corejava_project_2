...
/**
 * The StudentValidator class provides methods to validate different attributes
 * of a student.
 */
public class StudentValidator {
	 ...
	 * @throws IllegalArgumentException if the name is empty, null, or doesn't match
	 ...
	 * @throws IllegalArgumentException if the mobile number is empty, null, or
	 ...
	 * @throws IllegalArgumentException if the password is empty, null, or doesn't
	 ...
	 * @return true if the emailid is correct with the regex pattern.
	 * @throws IllegalArgumentException if the email is not valid input.
	 */

	public static boolean validateEmailId(String emailId) throws IllegalArgumentException {
		if (emailId == null) {
			throw new IllegalArgumentException(StudentValidatorErrors.INVALID_EMAILID);
		}
